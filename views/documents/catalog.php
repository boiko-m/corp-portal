...
<div class="row">
  <div class="col-8">
    <div class="row">
      <div class="col-12 m-b-30">
        <div class="card">
            <h6 class="card-header news-title">1.Bourgault Industries</h6>
            <div class="card-body">
    ...
    <div class="row">
      <div class="col-12 m-b-30">
        <div class="card">
            <h6 class="card-header news-title">2.Buhle</h6>
            <div class="card-body">
                <p class="card-text">Login as Guest </p>
    ...
    <div class="row">
      <div class="col-md-12 m-b-30">
        <div class="card">
            <h6 class="card-header news-title">3.CASE+NewHolland.rdp</h6>
            <div class="card-body">
                    <p class="card-text">
    ...
    <div class="row">
      <div class="col-md-12 m-b-30">
        <div class="card">
            <h6 class="card-header news-title">4.Сase2015</h6>
            <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">5.CASE+NewHolland(online) и CASE+OtherBrands(online)</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">6.Сlaas.rdp</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">7. Cummins.rdp</h6>
          <div class="card-body">
              <p class="card-text">Логин: catalog-pxe\katalog <br>
      				Пароль: rfnfkju</p>
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">8. Foton</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">9. Great Plains</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">10. KUHN14</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">11. Lemken, Grimme, Kverneland, Rabe</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">12. McCormick.rdp</h6>
          <div class="card-body">
              <p class="card-text">Логин: catalog-pxe\katalog<br>
                  Пароль: rfnfkju<br></p>
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">13. DIECI</h6>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 m-b-30">
      <div class="card">
          <h6 class="card-header news-title">14. Haulotte</h6>
          <div class="card-body">
