  ...
  <div class="row" style="padding: 4px">
    <div class="col-md-2">
      <? if (isset($profile->img) && strlen($profile->img) > 0) : ?>
        <img src="/img/user/thumbnail_<?= $profile->img ?>" alt="user" class="rounded-circle ajax-tooltip-img">
      <? else : ?>
    ...
    <div class="col-md-9" style="margin-left: 20px">
      <div>
        <?= Html::a($profile->first_name . '&nbsp;' . $profile->last_name, Url::to(['/profiles/' . $profile->id]),
        ['class' => 'href-tooltip']) ?>
      </div>
