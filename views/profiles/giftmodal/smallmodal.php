        ...
        foreach ($gift as $value) {
            ...
            <div class="block-gift-view">
                 <span style="float: left">
                          ...
                          <? else: ?>
                              <img src="/images/users/avatar-1.jpg" alt="user"
                ...
                <img class="  gift-in-view" id="<?= $value['id'] ?>" src="<?= $img ?>"
                     style=" display: block; margin: 30px auto; padding: 20px;  height: 200px; width: 200px;">
